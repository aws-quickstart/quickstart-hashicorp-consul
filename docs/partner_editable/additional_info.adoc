...
|June 2022
|Allow users to choose Consul Version & ConsulTemplate Version; Use CloudFormation Template to deploy ACM certificates; General cleanup
|Changes in templates and throughout guide

|January 2020
|Updated use cases; added an Auto Scaling group for the bastion hosts; added a Classic Load Balancer with ACM support
|Changes in templates and throughout guide

|April 2017
|Added Linux bastion hosts; updated Consul to version 0.8.0; removed Seed server; added Amazon EC2 retry functionality
|Changes in templates and throughout guide
